...
import { 
  ChevronDown, Search, ShoppingCart, Globe, User, Menu, X, ChevronRight 
} from "lucide-react";
import { cn } from "@/lib/utils"; // ถ้าไม่มีไฟล์นี้ ให้ลบ import นี้ออกแล้วใช้ template literal ธรรมดาได้

// ==========================================
// 1. 📦 DATA STRUCTURE (ข้อมูลเมนูตามที่คุณลิสต์มา)
// ==========================================
        ...
        <div className="hidden lg:flex items-center gap-8 h-full">
          {["Home", "Shop", "About", "Blog", "Contact"].map((item) => (
            <div 
              ...
              onMouseEnter={() => {
                setActiveMenu(item);
                if (item === "Shop") setActiveCategory("New & Featured"); // Reset category when entering shop
              }}
            >
              <Link 
        ...
        <div className="absolute top-20 left-0 w-full bg-white border-b border-gray-100 shadow-xl animate-in fade-in slide-in-from-top-1 duration-200 hidden lg:block">
          <div className="max-w-[1440px] mx-auto flex h-[500px]">
            ...
            <div className="w-64 border-r border-gray-100 bg-gray-50/50 flex flex-col py-6">
              {Object.keys(SHOP_DATA).map((catName) => (
                <button
                  key={catName}
            ...
            <div className="flex-1 p-10 overflow-y-auto">
              ...
              <div className="grid grid-cols-3 gap-x-12 gap-y-10">
                {SHOP_DATA[activeCategory].groups.map((group: any, idx: number) => (
            ...
            <div className="w-[340px] p-4">
              <div className="relative w-full h-full rounded-2xl overflow-hidden group">
                ...
                <img 
                  src={SHOP_DATA[activeCategory].image} 
                  alt={activeCategory}
